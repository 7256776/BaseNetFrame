...
namespace WebIndividual
{
    public class FileUpdata 
    {
        ...
        public static AjaxResponse<WebFileInput> AppUpload(IFormFile formFile)
        {
            WebFileInput model = new WebFileInput();
            var ajaxResponse = new AjaxResponse<WebFileInput>(model)
            {
                Success = false
            };
