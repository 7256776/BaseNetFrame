...
var Layout = function() {
    ...
    var handleSidebarToggler = function () { 
        ...
        $('body').on('click', '.sidebar-toggler', function(e) {
            ...
            //获取logo  div对象
            var frameLogoPage = $('.frame-logo-page');
            var frameLogoTitle = $('.frame-logo-title');
            ...
            if (body.hasClass("page-sidebar-closed")) {
                ...
                //显示logo图标以及标题
                frameLogoPage.removeClass("frame-logo-page-close");
                frameLogoTitle.removeClass("frame-logo-page-close");
                ...
                //隐藏logo图标以及标题
                frameLogoPage.addClass("frame-logo-page-close");
                frameLogoTitle.addClass("frame-logo-page-close");
