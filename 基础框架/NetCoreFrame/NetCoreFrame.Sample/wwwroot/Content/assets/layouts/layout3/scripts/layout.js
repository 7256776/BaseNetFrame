...
var Layout = function () {
    ...
    // 注册主菜单点击展开事件(单独注册)
    var handleMainMenuDropdown = function () {
        //注销事件(避免重复注册事件)
        $(".hor-menu .menu-dropdown > a, .hor-menu .dropdown-submenu > a").off("click");
        // 注册在移动设备下子下拉菜单点击事件
    ...
    return {
        ...
        initMainMenuDropdown: function () {
            handleMainMenuDropdown(); // handles menu toggle for mobile
        },
