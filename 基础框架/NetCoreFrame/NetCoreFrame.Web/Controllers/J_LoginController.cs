...
namespace NetCoreFrame.Web.Controllers
{
    ...
    public class J_LoginController : NetCoreFrameControllerBase
    {
        ...
        private string GetAppHomeUrl()
        {
            ...
            return "/J_Home/Index/#/Views/J_Home/DesktopPage";
            // return Url.Action("Index", "J_Home");
        }
