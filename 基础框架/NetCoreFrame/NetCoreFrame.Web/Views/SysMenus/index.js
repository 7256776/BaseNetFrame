...
var component = Vue.component('sys-menus', {
    template: Vue.frameTemplate('SysMenus/Index'),
    created: function () {
        this.initMenusData();
    },
    data: function () {
    ...
    methods: {
        ...
        validatePermission: function (rule, value, callback) {
            ...
            abp.ajax({
                url: '/SysMenus/IsPermissionRepeat',
