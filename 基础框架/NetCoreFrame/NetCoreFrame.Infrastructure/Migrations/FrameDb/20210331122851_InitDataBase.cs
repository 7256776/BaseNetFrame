        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BusinessType = table.Column<string>(maxLength: 20, nullable: true),
                    Description = table.Column<string>(maxLength: 2000, nullable: true),
                    CustomData = table.Column<string>(maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotificationDescribe = table.Column<string>(maxLength: 200, nullable: true),
            ...
            migrationBuilder.InsertData(
                schema: "dbo",
                table: "Sys_Menus",
                columns: new[] { "Id", "BusinessType", "CustomData", "Description", "Icon", "IsActive", "MenuDisplayName", "MenuName", "OrderBy", "ParentID", "PermissionName", "RequiresAuthModel", "Url" },
                values: new object[,]
                {
                    { 11L, "1", null, null, "fa-windows", true, "流程基础数据", "sys-flowconfig", 1, 10L, "FlowConfig", "2", "/Views/SysFlowDesigner/FlowConfig" },
                    { 1L, "1", null, null, "fa-list-ol", true, "系统设置", "sys-config", 1, null, "", "3", "" },
                    { 2L, "1", null, null, "fa-list-ol", true, "菜单管理", "sys-menus", 1, 1L, "MenusManager", "3", "/Views/SysMenus/Index" },
                    { 3L, "1", null, null, "fa-users", true, "用户管理", "sys-account", 2, 1L, "UserInfoManager", "3", "/Views/SysAccount/index" },
                    { 4L, "1", null, null, "fa-vcard", true, "角色管理", "sys-roles", 3, 1L, "RoleManager", "3", "/Views/SysRole/Index" },
                    { 5L, "1", null, null, "fa-bullhorn", true, "消息通知", "sys-notifications", 5, 1L, "NotificationsManager", "3", "/Views/SysNotifications/Index" },
                    { 6L, "1", null, null, "fa-book", true, "日志管理", "sys-auditlogs", 7, 1L, "LogManager", "3", "/Views/SysAuditLogs/Index" },
                    { 7L, "1", null, null, "fa-university", true, "组织机构", "sys-org", 6, 1L, "OrgManager", "3", "/Views/SysOrg/Index" },
                    { 8L, "1", null, null, "fa-bookmark", true, "字典管理", "sys-dict", 7, 1L, "DictManager", "3", "/Views/SysDict/Index" },
                    { 9L, "1", null, null, "fa-windows", true, "OIDC授权", "sys-authorization", 9, 1L, "AuthorizationManager", "3", "/Views/SysAuthorization/Index" },
                    { 10L, "1", null, null, "fa-windows", true, "流程管理", "sys-flow", 10, 1L, "Flow", "2", "/" },
                    { 12L, "1", null, null, "fa-windows", true, "流程设计器", "sys-flowdesigner", 2, 10L, "FlowDesigner", "2", "/Views/SysFlowDesigner/Index" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("0bfb0ddd-bb12-4059-87a1-4e0294643ea4"), new DateTime(2021, 3, 31, 20, 28, 51, 89, DateTimeKind.Local).AddTicks(1800), null, "提供系统默认提示消息", "系统通知", "system", "sms" });

            migrationBuilder.InsertData(
                schema: "dbo",
                table: "Sys_NotificationSubscriptions",
                columns: new[] { "Id", "CreationTime", "CreatorUserId", "EntityId", "EntityTypeAssemblyQualifiedName", "EntityTypeName", "NotificationName", "TenantId", "UserId" },
                values: new object[,]
                {
                    { new Guid("d9aed633-e9ae-40e6-8ad4-4eec083b03b0"), new DateTime(2021, 3, 31, 20, 28, 51, 89, DateTimeKind.Local).AddTicks(5728), null, null, null, null, "system", 1, 1L },
                    { new Guid("15812862-b2d7-45e2-826e-25545057c334"), new DateTime(2021, 3, 31, 20, 28, 51, 89, DateTimeKind.Local).AddTicks(6894), null, null, null, null, "system", 1, 2L }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, new DateTime(2021, 3, 31, 20, 28, 51, 80, DateTimeKind.Local).AddTicks(8469), null, "动态生成的角色", true, null, null, "admin角色", null });

            migrationBuilder.InsertData(
                schema: "dbo",
                table: "Sys_Setting",
                columns: new[] { "Id", "CreationTime", "CreatorUserId", "LastModificationTime", "LastModifierUserId", "Name", "TenantId", "UserId", "Value" },
                values: new object[] { new Guid("ecf6faa6-27d6-4056-bb32-91357b639824"), new DateTime(2021, 3, 31, 20, 28, 51, 89, DateTimeKind.Local).AddTicks(9305), null, null, null, "Abp.Localization.DefaultLanguageName", null, null, "zh-Hans" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, new DateTime(2021, 3, 31, 20, 28, 51, 81, DateTimeKind.Local).AddTicks(4560), null, null, null, null, null, "m", true, true, false, null, null, null, null, "AQAAAAEAACcQAAAAEL4Jvdbmz2uKeI7blzH90zphO6Ej86+WwhTSgUTh5XCf3Uv5FetLJBl+qNcLOgEVAw==", null, "1", null, "sys", "管理员" },
                    { 2L, new DateTime(2021, 3, 31, 20, 28, 51, 87, DateTimeKind.Local).AddTicks(208), null, null, null, null, null, "2", true, false, false, null, null, null, null, "AQAAAAEAACcQAAAAEAvAFT2taVzbRxD/Nv0A8T1xtWThUKXhlnulkg8IWPuUvg5q3SR/HZQuktKqec0yvA==", null, "0", null, "admin", "管理员" }
                });
