    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 7L, null, null, "fa-university", true, "组织机构", "j-org", 6, 1L, "OrgManager", "2", "/Views/J_Org/Index" },
                    { 1L, null, null, "fa-list-ol", true, "系统设置", "j-sys", 1, null, "", "1", "" },
                    { 2L, null, null, "fa-list-ol", true, "菜单管理", "j-menus", 1, 1L, "MenusManager", "3", "/Views/J_Menus/Index" },
                    { 3L, null, null, "fa-users", true, "用户管理", "j-account", 2, 1L, "UserInfoManager", "3", "/Views/J_Account/index" },
                    { 4L, null, null, "fa-vcard", true, "角色管理", "j-roles", 3, 1L, "RoleManager", "3", "/Views/J_Role/Index" },
                    { 5L, null, null, "fa-bullhorn", true, "消息通知", "j-notifications", 5, 1L, "NotificationsManager", "3", "/Views/J_Notifications/Index" },
                    { 6L, null, null, "fa-book", true, "日志管理", "j-auditlogs", 7, 1L, "LogManager", "3", "/Views/J_AuditLogs/Index" },
                    { 8L, null, null, "fa-bookmark", true, "字典管理", "j-dict", 7, 1L, "DictManager", "3", "/Views/J_Dict/Index" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("0bfb0ddd-bb12-4059-87a1-4e0294643ea4"), new DateTime(2019, 1, 21, 16, 16, 0, 474, DateTimeKind.Local), null, "提供系统默认提示消息", "系统通知", "system", "sms" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("d9aed633-e9ae-40e6-8ad4-4eec083b03b0"), new DateTime(2019, 1, 21, 16, 16, 0, 475, DateTimeKind.Local), null, null, null, null, "system", 1, 1L },
                    { new Guid("15812862-b2d7-45e2-826e-25545057c334"), new DateTime(2019, 1, 21, 16, 16, 0, 475, DateTimeKind.Local), null, null, null, null, "system", 1, 2L }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, new DateTime(2019, 1, 21, 16, 16, 0, 456, DateTimeKind.Local), null, "动态生成的角色", true, null, null, "admin角色", null });

            migrationBuilder.InsertData(
                schema: "dbo",
                table: "Sys_Settings",
                columns: new[] { "Id", "CreationTime", "CreatorUserId", "LastModificationTime", "LastModifierUserId", "Name", "TenantId", "UserId", "Value" },
                values: new object[] { new Guid("ecf6faa6-27d6-4056-bb32-91357b639824"), new DateTime(2019, 1, 21, 16, 16, 0, 475, DateTimeKind.Local), null, null, null, "Abp.Localization.DefaultLanguageName", null, null, "zh-Hans" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, new DateTime(2019, 1, 21, 16, 16, 0, 457, DateTimeKind.Local), null, null, null, null, null, "m", true, true, false, null, null, null, null, "AQAAAAEAACcQAAAAEF4hRBip796ldF36oefY9VkCwZcx4mPmvbLiqGY0XpI6lSbYXDSfD1+ELnf2JtdSNA==", null, "1", null, "sys", "管理员" },
                    { 2L, new DateTime(2019, 1, 21, 16, 16, 0, 466, DateTimeKind.Local), null, null, null, null, null, "2", true, true, false, null, null, null, null, "AQAAAAEAACcQAAAAEAqBPMFMONfSOzesZU7+zDgMIuQtdyL6rjnbn220b4ICIoUyY4fTtbJ9MGE8EGdWHQ==", null, "0", null, "admin", "管理员" }
                });
