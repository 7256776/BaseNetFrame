...
var QuickSidebar = function () {
    ...
    var handleQuickSidebarChat = function () {
        ...
        wrapper.find('.page-quick-sidebar-chat-users .media-list > .media').click(function (e) {
        ...
        var handleChatMessagePost = function (e) {
            ...
            //setTimeout(function(){
            //    var time = new Date();
            //    var message = preparePost('in', (time.getHours() + ':' + time.getMinutes()), "Ella Wong", 'avatar2', '假吗回复消息...');
            //    message = $(message);
            //    chatContainer.append(message);
    ...
    // 处理滚动条位置
    var chatContainerSlimScroll = function () {
        var wrapper = $('.page-quick-sidebar-wrapper');
        var wrapperChat = wrapper.find('.page-quick-sidebar-chat');
        var chatContainer = wrapperChat.find(".page-quick-sidebar-chat-user-messages");
        chatContainer.slimScroll({
    ...
    return {
        ...
        //处理滚动条位置
        setChatSlimScroll: function () {
            chatContainerSlimScroll();              //消息窗体滚动条
        },
