...
namespace Frame.Core
{
    ...
    public class SysOrgRepository : EfRepositoryBase<DataDbContext, SysOrg, Guid>, ISysOrgRepository
    {
        ...
        public SysOrgRepository(IDbContextProvider<DataDbContext> dbcontext, IUnitOfWorkManager unitOfWorkManager) :
            base(dbcontext)
        {
