...
namespace Frame.Core
{
    ...
    public class SysRolesRepository : EfRepositoryBase<DataDbContext, SysRoles, long>, ISysRolesRepository
    {
        ...
        public SysRolesRepository(IDbContextProvider<DataDbContext> dbcontext) : base(dbcontext)
        {
        }
