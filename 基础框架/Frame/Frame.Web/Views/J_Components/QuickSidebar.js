...
var component = Vue.component('j-quicksidebar', {
    template: Vue.frameTemplate('J_Components/QuickSidebar'),
    created: function () {
        //注册聊天消息窗体的刷新事件
    ...
    methods: {
        ...
        getChat: function (senderUserId,count) {
            ...
            abp.ajax({
                url: '/J_Notifications/GetChatRecordList',
                data: JSON.stringify(param)
            }).done(function (data) {
                //获取所有未读的消息数量
