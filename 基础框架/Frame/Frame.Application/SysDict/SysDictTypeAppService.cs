...
{
    [Audited]
    public class SysDictTypeAppService : FrameExtApplicationService, ISysDictTypeAppService
    {
        ...
        public async Task<AjaxResponse> SaveSysDictTypeModel(SysDictTypeInput model)
        {
            ...
            {
                return new AjaxResponse { Success = false, Error = new ErrorInfo("您设置的字典类型值" + model.DictType + "重复!") };
